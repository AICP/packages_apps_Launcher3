...
public class InvariantDeviceProfile {
    ...
    private void applyPartnerDeviceProfileOverrides(Context context, DisplayMetrics dm) {
        Preference pref = context.getPreference(LauncherFiles.PREFERENCE_KEY, Context.MODE_PRIVATE);
        String rowVal = pref.getString("custom_grid_rows", "5");
        String colVal = pref.getString("custom_grid_cols", "5");
    try {
