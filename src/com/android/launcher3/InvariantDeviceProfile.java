...
public class InvariantDeviceProfile {
    ...
    String rowString = prefs.getString("custom_grid_rows", "5");
    String colString = prefs.getString("custom_grid_cols", "5");

    try {
        int customRows = Integer.parseInt(rowString);
        int customCols = Integer.parseInt(colString);
        ...
        Log.e("IDP", "Invalid grid size format: " + rowString + "x" + colString, e);
    }
