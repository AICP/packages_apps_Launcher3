...
public class DeviceProfile {
    ...
    public DeviceProfile(Context context, InvariantDeviceProfile inv,
        ...
        hotseatBarBottomPaddingPx = (isTallDevice ? 0
                ...
                + (Utilities.showHotseatQSB(context) ? res.getDimensionPixelSize(R.dimen.dynamic_grid_hotseat_bottom_padding)
                      : res.getDimensionPixelSize(R.dimen.dynamic_grid_hotseat_bottom_padding_no_qsb));
